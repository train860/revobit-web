  ...
  return (
    <>
      <SectionCard
        ...
        list={[
          {
            icon: "/images/trends/i27.png",
            text: "海量电商热销款式",
            description: "淘宝、天猫、抖音电商、亚马逊等电商平台的海量热销款式",
          },
          {
            icon: "/images/trends/i28.png",
            text: "全网潮搭款式聚合",
            description:
              "数百万instagram、抖音、小红书、微博等社交平台的鞋服类潮人穿搭",
          },
          {
            icon: "/images/trends/i29.png",
            text: "潮流爆款元素拆解",
            description:
